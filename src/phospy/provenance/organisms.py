"""Canonical organism identity values shared by provenance and science domains."""
...
def organism_value(value: Organism | str) -> str:
    """Return the canonical string value for organism-like values."""

    return value.value if isinstance(value, Organism) else str(value)
