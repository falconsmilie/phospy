...
SIGNALOME_MODULE_SELECTION_STABILITY_DEFAULT_PERTURBATIONS = 8
SIGNALOME_MODULE_SELECTION_STABILITY_DEFAULT_MAX_SITES = 256
SIGNALOME_MODULE_SELECTION_STABILITY_PERTURBATION_SCALE = 0.01
SIGNALOME_MODULE_SELECTION_STABILITY_THRESHOLD_DELTA = 0.05
