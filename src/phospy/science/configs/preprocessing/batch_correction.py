...
from phospy.science.configs._validation import (
...
class SpsRuvBatchCorrectionConfig:
    ...
    def condition_column(self) -> str:
        """Primary condition column retained for single-column compatibility."""

        return self.condition_columns[0]
...
def validate_native_executable_temporary_imputation_method(
    ...
    if method in NATIVE_RECOGNIZED_TEMPORARY_IMPUTATION_POLICY_LABELS:
        return
