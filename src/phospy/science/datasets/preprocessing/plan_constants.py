...
PREPROCESSING_STAGE_ORDER_RATIONALE_LOG2_IMPUTATION_INTENSITY_TRANSFORM = (
    "missing_data.input_scale='log2' requires log2 intensity space, so "
    "intensity_transform runs before missing_data."
)

PREPROCESSING_STAGE_ORDER_RATIONALE_LOG2_IMPUTATION_MISSING_DATA = (
    "missing_data runs after log2 transformation because "
    "missing_data.input_scale='log2'."
)
