...
This package owns the transformation of raw or semi-structured phosphoproteomic
inputs into analysis-ready forms, including filtering, correction,
normalisation, imputation, and site-matrix preparation."""
