...
GROUP_AWARE_ROUTING_CONTRACT_N_SITES = 10_000
GROUP_AWARE_ROUTING_CONTRACT_N_SAMPLES = 12
GROUP_AWARE_FULL_STAGE_CONTRACT_N_SITES = 1_200
GROUP_AWARE_FULL_STAGE_CONTRACT_N_SAMPLES = 6
GROUP_AWARE_FULL_STAGE_CONTRACT_N_GROUPS = 2
GROUP_AWARE_FULL_STAGE_FACT_INDEX_BUILDS_MAX = 1
GROUP_AWARE_FULL_STAGE_FACT_SEQUENCE_PASSES_MAX = 1
GROUP_AWARE_FULL_STAGE_ROW_LOOKUPS_PER_AUDITED_ROW_MAX = 4
...
GROUP_AWARE_ROUTING_RUNTIME_SECONDS_MAX = 8.0
GROUP_AWARE_ROUTING_PEAK_MIB_MAX = 256.0
...
SPS_DISCOVERY_RUNTIME_SECONDS_MAX = 20.0
