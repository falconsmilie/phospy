...
comparisons <- list(
  c("group1", "group4", "2277.IgM.5min", "2277.IgM.60min"),
  c("group2", "group5", "2277.IgM.cAMP.5min", "2277.IgM.cAMP.60min"),
  c("group3", "group6", "2282.IgM.5min", "2282.IgM.60min"),
  c("group1", "group2", "2277.IgM.5min", "2277.IgM.cAMP.5min"),
  c("group1", "group3", "2277.IgM.5min", "2282.IgM.5min"),
  c("group2", "group3", "2277.IgM.cAMP.5min", "2282.IgM.5min"),
  c("group4", "group5", "2277.IgM.60min", "2277.IgM.cAMP.60min"),
  c("group4", "group6", "2277.IgM.60min", "2282.IgM.60min"),
  c("group5", "group6", "2277.IgM.cAMP.60min", "2282.IgM.60min")
)
