...
| tests/unit/test_prediction_sequence_validation.py | test_kinase_workflow_exposes_sequence_validation_diagnostics | 425 | `min_substrates=2,` |
| tests/unit/test_prediction_sequence_validation.py | test_kinase_workflow_reports_partial_sequence_coverage_in_provenance | 581 | `scoring_config=KinaseScoringConfig(min_substrates=2),` |
| tests/unit/test_prediction_sequence_validation.py | test_kinase_workflow_continues_when_no_sites_have_valid_sequence | 652 | `min_substrates=2,` |
...
| tests/unit/test_prediction_sequence_validation.py | test_motif_library_accepts_valid_reference_sequence_and_builds_profile | 678 | `kinase_substrate_map=pd.DataFrame(` |
| tests/unit/test_prediction_sequence_validation.py | test_motif_library_excludes_invalid_reference_windows_and_reports_diagnostics | 705 | `kinase_substrate_map=pd.DataFrame(` |
| tests/unit/test_prediction_sequence_validation.py | test_invalid_reference_sequences_do_not_change_motif_profile | 751 | `valid_map = pd.DataFrame(` |
| tests/unit/test_prediction_sequence_validation.py | test_motif_library_validation_rows_preserve_reference_provenance | 924 | `kinase_substrate_map=pd.DataFrame(` |
| tests/unit/test_prediction_sequence_validation.py | test_query_sequence_validation_behavior_remains_unchanged_with_library_validation | 957 | `kinase_substrate_map=pd.DataFrame(` |
...
| File | Test | Line | Evidence |
| --- | --- | ---: | --- |
| tests/unit/test_prediction_sequence_validation.py | test_kinase_workflow_exposes_sequence_validation_diagnostics | 401 | `references = ReferenceBundle(` |
| tests/unit/test_prediction_sequence_validation.py | test_kinase_workflow_reports_partial_sequence_coverage_in_provenance | 557 | `references = ReferenceBundle(` |
| tests/unit/test_prediction_sequence_validation.py | test_kinase_workflow_continues_when_no_sites_have_valid_sequence | 633 | `references = ReferenceBundle(` |
| tests/unit/test_validation_ownership.py | test_reference_compatibility_is_enforced_at_workflow_runtime_boundary | 98 | `references=ReferencePreset.HUMAN,` |
