...
PhosPy docs are structured as a product manual first, with deep engineering
material available when needed.

## Start Here

If you are new to PhosPy, use this sequence:
...
3. [Workflow overview](workflow-guides/index.md)
...
Contributor, architecture, ADR, and process-heavy pages are grouped under
[Maintainer docs](contributor/index.md) so they stay available without
overloading the public landing flow.
