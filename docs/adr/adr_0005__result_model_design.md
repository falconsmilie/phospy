...
- `result.activity_result.activity_matrix` (`activity_scores` and `weighted_activity` compatibility aliases)
...
- primary `activity_matrix` (`activity_scores` and `weighted_activity` compatibility aliases)
