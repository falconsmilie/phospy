...
That command runs lint, type checking, the default non-parity test suite, parity
tests, performance contracts, checked-in reference-bundle validation, and a
...
shape, dependency constraints, and packaged-reference build checks. Scientific
runtime invariants remain protected by focused unit, integration, parity,
golden, validation, workflow, architecture, and performance tests.
